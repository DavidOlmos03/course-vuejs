...
<script setup>
    ...
    const submitHandler = async data => {
        // Tecnica para sacar elementos de un objeto sin modificar el objeto original
...
<template>
    <div>
        ...
        <div class="flex justify-center bg-white shadow">
            <div class="mt-10 p-10 w-full 2xl:w-2/4"> <!--el media query 2xl:2/4  es para que tome la mitad de la pantalla-->
                <FormKit
                type="form"
