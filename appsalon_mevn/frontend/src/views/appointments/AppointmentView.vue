<script setup>
    ...
    // Condicionando las fechas permitidas de elegir en el calendario 
...
<template>
    <div>
        ...
        <p v-if="appointments.noServicesSelected" class="text-center text-white text-2xl">
        ...
        <div class="space-y-8" v-if="!appointments.noServicesSelected">
            ...
            <div class="lg:flex gap-5 items-start">
                ...
                <div v-if="appointments.isDateSelected" class="flex-1 grid grid-cols-1 xl:grid-cols-2 gap-2 mt-10 lg:mt-0">
                    <button
            ...
            <div v-if="appointments.isValidReservation" class="flex justify-end">
                <button 
                    class="x-full md:w-auto bg-blue-500 p-3 rounded-lg uppercase font-black text-white"
