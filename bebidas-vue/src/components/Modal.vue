    ...
    const formatearIngredientes = ()=>{
        ...
        for (let i = 1; i <= 15; i++) {
            if (bebidas.receta[`strIngredient${i}`]) {
                ...
                ingredienteCantidad.classList.add('text-lg', 'text-gray-500','font-extrabold')
              ...
              <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6" >
                <div>
                  <div class="mt-3">
                    ...
                    <img :src="bebidas.receta.strDrinkThumb" 
                    ...
                    <p class="text-lg font-extrabold text-gray-500">{{ bebidas.receta.strInstructions }}</p>
                  </div>
                </div>
